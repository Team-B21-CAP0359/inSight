...
//            application.assets.open("labels.txt").bufferedReader().use { it.readText() }.split("\n")
        ...
        //model belum bisa di terapkan - tujuan mendeteksi apakah yang di upload benar2 baju atau bukan
...
//
    ...
    private fun uploadImage() {
        ...
        val storageReference =
            FirebaseStorage.getInstance().getReference("images/$fileName-image/shirt")
